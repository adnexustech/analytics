...
export const HOMEPAGE_URL = 'https://ad.nexus';
export const REPO_URL = 'https://github.com/adnexustech/analytics';
export const UPDATES_URL = 'https://api.ad.nexus/v1/updates';
export const TELEMETRY_PIXEL = 'https://i.ad.nexus/a.png';
